...
export function buildRestaurants(ownersByName) {
  return [
    // ── Roberto Mendoza Vásquez ────────────────────────────
    {
      ...
      descripcion:
        "Auténtica cocina guatemalteca con recetas tradicionales de la abuela. Sabores únicos del altiplano y la costa.",
      ubicacion: { type: "Point", coordinates: [-90.5133, 14.6418] },
      direccion: {
        calle: "1a Avenida 9-15",
      ...
      horario: {
        ...
        viernes: { abre: "11:00", cierra: "23:00", cerrado: false },
        sabado: { abre: "10:00", cierra: "23:00", cerrado: false },
        domingo,
      },
    ...
    },
    {
      ...
      descripcion:
        "Pastas frescas, pizzas artesanales y postres italianos clásicos en el corazón de la Zona Viva.",
      ...
      horario: {
        ...
        miercoles: horarioNormal,
        jueves: horarioNormal,
        viernes: { abre: "12:00", cierra: "23:00", cerrado: false },
    ...
    // ── Lucía Hernández Ruiz ───────────────────────────────
    {
      ...
      descripcion:
        "Las mejores hamburguesas artesanales de Guatemala. Carne 100% nacional, ingredientes frescos, sabor insuperable.",
      ...
      horario: {
        ...
        miercoles: horarioNormal,
        jueves: horarioNormal,
        viernes: { abre: "10:00", cierra: "23:30", cerrado: false },
        sabado: { abre: "10:00", cierra: "23:30", cerrado: false },
        domingo,
      },
    ...
    },
    {
      ...
      nombre: "Sushi Zen",
      descripcion:
        "Experiencia japonesa auténtica. Sushi fresco, sashimi premium y sake seleccionado para los amantes de la cocina nipona.",
    ...
    // ── Pablo Godínez Ajú ──────────────────────────────────
    {
      ...
      descripcion:
        "Cocina vegana y plant-based de alta calidad. Ingredientes orgánicos locales, sin ningún producto de origen animal.",
      ubicacion: { type: "Point", coordinates: [-90.5188, 14.6178] },
      direccion: {
        calle: "Ruta 6, 3-45 Zona 4",
        ciudad: "Guatemala City",
        pais: "Guatemala",
        codigo_postal: "01004",
      },
    ...
    },
    {
      ...
      nombre: "Tacos & More",
      descripcion:
        "Sabores mexicanos auténticos: tacos al pastor, burritos, guacamole fresco y más. La mejor comida tex-mex en Guatemala.",
      ...
      horario: {
        ...
        jueves: horarioNormal,
        viernes: { abre: "11:00", cierra: "23:00", cerrado: false },
        sabado: { abre: "11:00", cierra: "23:00", cerrado: false },
        domingo,
      },
    ...
    // ── Carmen Estrada Xol ─────────────────────────────────
    {
      ...
      descripcion:
        "Pescado y mariscos frescos traídos directamente del Pacífico guatemalteco. Ceviche, camarones y parrilladas de mar.",
      ...
      horario: {
        ...
        miercoles: horarioNormal,
        jueves: horarioNormal,
        viernes: { abre: "10:00", cierra: "22:00", cerrado: false },
    ...
    },
    {
      ...
      nombre: "Café Central",
      descripcion:
        "El mejor café guatemalteco de altura acompañado de desayunos chapines, waffles y pasteles artesanales.",
