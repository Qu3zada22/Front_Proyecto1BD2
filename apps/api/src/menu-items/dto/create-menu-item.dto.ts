...
export class CreateMenuItemDto {
    @ApiProperty({ example: '64a1b2c3d4e5f6a7b8c9d0e1', description: 'ID del restaurante' })
    ...
    @ApiProperty({ enum: ['entrada', 'principal', 'postre', 'bebida', 'extra'], example: 'principal' })
    @IsEnum(['entrada', 'principal', 'postre', 'bebida', 'extra']) categoria: string;
