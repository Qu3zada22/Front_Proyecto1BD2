...
class DireccionDto {
  ...
  @ApiPropertyOptional({ example: '01010' })
  @IsOptional()
  @IsString()
...
export class CreateRestauranteDto {
  ...
  @ApiProperty({
    type: UbicacionDto,
    description: 'Punto GeoJSON para búsqueda geoespacial',
  })
  @ValidateNested()
  @Type(() => UbicacionDto)
  ...
  @ApiPropertyOptional({
    example: ['hamburguesas', 'americana'],
    type: [String],
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    example: { lunes: { abre: '08:00', cierra: '22:00', cerrado: false } },
  })
  @IsOptional()
