...
export const DireccionRestauranteSchema =
  SchemaFactory.createForClass(DireccionRestaurante);
...
RestauranteSchema.index(
  { nombre: 1, activo: 1 },
  { name: 'idx_restaurantes_nombre_activo' },
);
// Compuesto: restaurantes activos de un propietario
RestauranteSchema.index(
  { propietario_id: 1, activo: 1 },
  { name: 'propietario_activo_compound' },
);
