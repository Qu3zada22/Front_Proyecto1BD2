...
export class CreateResenaDto {
    ...
    @ApiPropertyOptional({ example: '64a1b2c3d4e5f6a7b8c9d0e2', description: 'ID del restaurante (requerido si no se provee orden_id)' })
    @ValidateIf(o => !o.orden_id)
    @IsString() restaurante_id?: string;

    @ApiPropertyOptional({ example: '64a1b2c3d4e5f6a7b8c9d0e3', description: 'ID de la orden (requerido si no se provee restaurante_id)' })
