...
export class ResenasController {
  ...
  @ApiOperation({
    ...
    description:
      'Filtra activa:true. Usa índice restaurante_id + calificacion.',
  })
  ...
  findByRestaurant(
    ...
    return this.resenasService.findByRestaurant(
      id,
      sort,
      +skip || 0,
      +limit || 10,
  ...
  @ApiOperation({
    ...
    description: 'Usa $addToSet para evitar duplicados en el array likes.',
  })
  ...
  @ApiOperation({
    summary: 'Quitar like de reseña',
    description: 'Usa $pull para remover el userId del array likes.',
  })
  @ApiParam({ name: 'id', description: 'ObjectId de la reseña' })
