...
export class FilesController {
    ...
    @Post('upload')
    @ApiOperation({ summary: 'Subir archivo a GridFS', description: 'Sube un archivo y lo almacena en MongoDB GridFS. Devuelve el fileId.' })
    ...
    @Get()
    @ApiOperation({ summary: 'Listar archivos en GridFS', description: 'Devuelve metadatos de todos los archivos almacenados.' })
    listFiles() {
        return this.filesService.listFiles();
    }

    @Get(':id')
    @ApiOperation({ summary: 'Descargar archivo de GridFS', description: 'Hace stream del archivo desde GridFS hacia el cliente.' })
