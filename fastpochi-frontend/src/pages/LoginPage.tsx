...
export default function LoginPage() {
  ...
  const demoUsers = [
    {
      label: "Cliente",
      email: usuarios.find((u) => u.rol === "cliente")?.email || "",
    },
    {
      label: "Propietario",
      email: usuarios.find((u) => u.rol === "propietario")?.email || "",
    },
    {
      label: "Admin",
      email: usuarios.find((u) => u.rol === "admin")?.email || "",
    },
  ];
