...
| ---------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| usuarios   | `idx_usuarios_rol_activo` {rol,activo}                              | — _(no es redundante, es complementario)_                                      |
| usuarios   | _(ninguno)_                                                         | `rol_simple` {rol} ← redundante con el compound                                |
...
| menu_items | `idx_menuitems_restaurante_disponible` {restaurante_id, disponible} | — _(no es redundante, diferente prefix)_                                       |
...
`_id_`, `email_unique`, `direcciones_ciudad_multikey`, `nombre_text`, `rol_simple` _(redundante)_, `idx_usuarios_rol_activo`

### menu_items (redundancia low)

`_id_`, `etiquetas_multikey`, `nombre_descripcion_text`, `veces_ordenado_desc`, `restaurante_categoria_disponible_esr`, `idx_menuitems_restaurante_disponible`, `idx_menuitems_restaurante_categoria` _(redundante con ESR)_
